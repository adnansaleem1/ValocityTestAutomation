...
namespace VelocityTestCases.References
{
    static class Credentials
    {
        ...
        public static VelocityUser VelocityEIT_User;
        public static VelocityUser VelocityExternal_User ;
        public static APIUser APIV2_User ;
        public static APIUser APIV3_User;
