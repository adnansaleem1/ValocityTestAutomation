...
{
    class PriceObjectMPG
    {
        public PriceFill ProductPrice { get; set; }
        public PriceObjectMPG()
        {
            this.InIt();
            this.SetGridType();
        ...
        {
            ProductPrice.GridType = PricegridType.MultipleGrid;
        ...
        private void SetInfoForGrids()
        {
            ...
            grid = new PriceGridFill("S,M", 0, PricesList, CritariaList);
            ...
            grid = new PriceGridFill("L", 0, PricesList, CritariaList);
            this.ProductPrice.SetPriceGrid(grid);
